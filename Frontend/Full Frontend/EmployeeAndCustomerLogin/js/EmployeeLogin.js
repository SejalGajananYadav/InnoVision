...
document.addEventListener("DOMContentLoaded", function() {
    ...
    loginForm.addEventListener("submit", function(event) {
        ...
        // Replace with your hardcoded employee username and password
        const hardcodedUsername = "Employee1";
        const hardcodedPassword = "Employee1@123";
        ...
        if (enteredUsername === hardcodedUsername && enteredPassword === hardcodedPassword) {
            // Successful login, redirect to employee-dashboard.html
            window.location.href = "../OrderManagementPages/OrderManagementEmployee.html";
        } else {
